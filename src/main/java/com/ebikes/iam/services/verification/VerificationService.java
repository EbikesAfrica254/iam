...
public class VerificationService {
    ...
    private void dispatchNotification(
        ...
        switch (notificationType) {
            case ACCOUNT_ACTIVATION -> notificationService.sendAccountVerification(
                    organizationId, organizationName, userExtension);
            case EMAIL_OTP -> notificationService.sendEmailVerification(
                    organizationId, organizationName, userExtension);
            case PHONE_OTP -> notificationService.sendPhoneVerification(
                    organizationId, organizationName, userExtension);
            default -> throw new IllegalStateException("Unhandled notification type: " + notificationType);
        }
    }
