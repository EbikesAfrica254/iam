...
public class EventConstants {
    ...
    public static final class EventTypes {
        ...
        public static final class IAM {
            ...
            public static final String ACCOUNT_ACTIVATED =
                    EventSource.HOST_SERVICE + ".account.activated";
            public static final String ACCOUNT_DEACTIVATED =
                    EventSource.HOST_SERVICE + ".account.deactivated";
            ...
            public static final String CONTACT_EXPIRED = EventSource.HOST_SERVICE + ".contact.expired";
            ...
            public static final String USER_SELF_REGISTERED =
                    EventSource.HOST_SERVICE + ".user.self-registered";
        }
    }
    ...
    public static final class InboxSourceContext {
        ...
        public static final String ORGANIZATION_APPROVED = "organizations.organization.approved";
        public static final String ORGANIZATIONS_SERVICE = "organizations";
