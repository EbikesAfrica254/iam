...
public interface ContactRepository
    ...
    List<Contact> findAllByStatusAndExpiresAtBefore(ContactStatus status, OffsetDateTime threshold);

    Optional<Contact> findByPhoneNumberAndOrganizationId(String phoneNumber, String organizationId);
}
