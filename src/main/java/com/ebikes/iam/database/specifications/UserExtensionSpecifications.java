...
public class UserExtensionSpecifications {
    ...
    public static Specification<UserExtension> isNotDeleted() {
        return (root, query, criteriaBuilder) ->
                criteriaBuilder.and(
                        criteriaBuilder.isNull(root.get(FIELD_DELETED_AT)),
                        criteriaBuilder.notEqual(root.get(FIELD_STATUS), UserStatus.DELETED));
    }
